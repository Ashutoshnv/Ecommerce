...
const uri = "mongodb+srv://root:root@cluster0.otowssm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    ...
    const bookCollection =  client.db("bookInventory").collection("book")
...
app.delete("/delete-book/:id",async(req,res)=>
{
  ...
  const result =await bookCollection.deleteOne({_id: new Object})
  res.send(result)
})

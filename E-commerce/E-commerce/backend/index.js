...
const uri = "mongodb+srv://root:root@cluster0.fkppg94.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
// book data repostary
  ...
  app.get("/filter-book/:category",async(req,res)=>{
    ...
    const book = bookCollection.find({bookCategory:category})
